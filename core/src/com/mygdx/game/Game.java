...
public class Game extends ApplicationAdapter {
	...
	public void create () {
		...
		h.addtoChildList(new Hitbox2(h, new ChildPositionHandler(), new Vector3(hitboxsize,hitboxsize)));
		h.setPosition(new Vector3(80,150));

		ControlPlayer.player = h;

		h2 = new Human(2,new Texture("testcharacter.png"),1,false);
		h2.addtoChildList(new Hitbox2(h2, new ChildPositionHandler(), new Vector3(hitboxsize,hitboxsize)));
		h2.setPosition(new Vector3(130,150));

		h3 = new Human(3,new Texture("testcharacter.png"),true);
		h3.addtoChildList(new Hitbox2(h3, new ChildPositionHandler(), new Vector3(hitboxsize*2,hitboxsize*2)));
		h3.setPosition(new Vector3(110,20));
	}
