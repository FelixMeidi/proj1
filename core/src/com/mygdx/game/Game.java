...
public class Game extends ApplicationAdapter {
	...
	public void create () {
		...
		h.addtoChildList(new TextureChild(new Texture("testcharacter.png"),h));
		...
		h2.addtoChildList(new TextureChild(new Texture("testcharacter.png"),h2));
		...
		h3.addtoChildList(new TextureChild(new Texture("SandStoneStreet.png"),h3));
		h3.addtoChildList(new TextureChild(new Texture("SandStoneStreet.png"),h3,new Vector3(32,0,0).multiplied(Renderer.scaling)));
